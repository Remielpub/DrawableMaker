...
//    }
    ...
    @JvmStatic
    fun cornerRadius(r: IntArray): IntArray {
        val radius = IntArray(4) { 0 }
        when (r.size) {
            0 -> {
...
//    }
    ...
    fun addDash(
        ...
        return StrokeProperty(stokeWith, stokeColor, dashWidth, dashGap)
    }
    ...
    fun addDash(
        ...
        return StrokeProperty(stokeWith, parseColor(stokeColor), dashWidth, dashGap)
    }
     ...
     */
    @JvmStatic
    fun addStroke(stokeWith: Int, @ColorInt stokeColor: Int): StrokeProperty {
        return StrokeProperty(stokeWith, stokeColor)
    }
     ...
     */
    @JvmStatic
    fun addStroke(stokeWith: Int, stokeColor: String): StrokeProperty {
        return StrokeProperty(stokeWith, parseColor(stokeColor))
    }
    ...
    @JvmStatic
    fun drawable(
        corners: CornerProperty? = null,
        stroke: StrokeProperty? = null,
        gradient: GradientProperty? = null
    ): Drawable {
        return GradientDrawable().apply {
            ...
            //添加描边
            stroke?.let {
                addStroke(it.strokeWith, it.strokeColor, it.dashWidth, it.dashGap)
            }
            gradient?.let {
                addGradient(it)
            }
...
//    }
    ...
    fun drawable(
        ...
        return GradientDrawable().apply {
            addGradient(colors, orientation, gradientType, gradientRadius, center, useLevel, level)
        }
    }
}
